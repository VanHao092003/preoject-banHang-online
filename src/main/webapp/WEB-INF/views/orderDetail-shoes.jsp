...
<head>
<meta charset="UTF-8">
<title>Chi tiết đơn hàng shoes</title>
...
<body>
    ...
    <form style="width: 100%;" action="/WebSellingShoes/check_successful">
            ...
            <input type="text" class="inputbox" name="ID_customer" value="${shoesCheck.ID}" required />
            <p style="margin-bottom: 5px; margin-top: 8px;">Tên Sản phẩm:</p>
            <input type="text" class="inputbox" name="name_customer" value="${shoesCheck.name}" required />
             <p style="margin-bottom: 5px; margin-top: 8px;">Giá của 1 sản phẩm:</p>
            <input type="text" class="inputbox" name="address_customer" value="${shoesCheck.money}" required />
